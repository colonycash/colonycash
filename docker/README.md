...
official/supported Docker Images found at https://hub.docker.com/r/colonycashpay/colonycashd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/colonycashpay/colonycashd-develop/ when changing the above text**