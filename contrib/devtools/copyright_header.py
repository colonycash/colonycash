...
EXPECTED_HOLDER_NAMES = [
    ...
    "The ColonyCash Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a ColonyCash Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The ColonyCash Core developers'
...
Arguments:
    <base_directory> - The base directory of ColonyCash Core source code repository.
"""
...
Arguments:
    <file> - A source file in the ColonyCash Core repository.
"""
