...
from test_framework.test_framework import ColonyCashTestFramework
...
class LLMQCoinbaseCommitmentsTest(ColonyCashTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ColonyCashTestFramework doesn't support this atm)
