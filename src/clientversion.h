...
//! These need to be macros, as clientversion.cpp's and colonycash*-res.rc's voodoo requires it
...
/**
 * colonycashd-res.rc includes this file, but it cannot cope with real c++ code.
