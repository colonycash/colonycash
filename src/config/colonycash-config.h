/* src/config/colonycash-config.h.  Generated from colonycash-config.h.in by configure.  */
/* src/config/colonycash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CCASH_CONFIG_H

#define CCASH_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The ColonyCash Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "ColonyCash Core"
...
#define PACKAGE_STRING "ColonyCash Core 1.0.0"
