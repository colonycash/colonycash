 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1565022308, nBits=1e0ffff0, nNonce=100030, vtx=1)
...
{
    const char* pszTimestamp = "Bitcoin has surged back above usd 10k per bitcoin";
    const CScript genesisOutputScript = CScript() << ParseHex("041199e7c85310a15d685dc307bc42621b6cdea4ee5f460b44698d634b2898381fda92d173037e8e4bc463566d7203fc08e6fd7ee3d10191a658681afee973f316") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000e9d7978d48ec061bd8a78da8bf452b41986016ca1e60d8614b8cc9ee2bb"); 
        ...
        vAlertPubKey = ParseHex("04ea4a0504b3c38d6a50d01276d5e2e70deb933843b74482b81b65ab9295e88036fb4471e670a2cb039a0728aa3ef4ccd81c33d58927abe94db1b185463fcc81f3");
        nDefaultPort = 11336;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1565022308, 100030, 0x1e0ffff0, 1, 100 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000e9d7978d48ec061bd8a78da8bf452b41986016ca1e60d8614b8cc9ee2bb"));
        assert(genesis.hashMerkleRoot == uint256S("0xb6a4cfad2b5005b482e15937e824f85c8ac7d3bf3e93c5a0d394611f50358b37"));


        vSeeds.push_back(CDNSSeedData("colony-cash.com", "node1.colony-cash.com"));
        vSeeds.push_back(CDNSSeedData("n2.colony-cash.com", "node2.colony-cash.com"));
        ...
        // ColonyCash BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // ColonyCash BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // ColonyCash BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"CTrYviiWpAMZ5JGAbBAh2DQW5uQXQDXWYa"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000e9d7978d48ec061bd8a78da8bf452b41986016ca1e60d8614b8cc9ee2bb"))
        };

        chainTxData = ChainTxData{
            1565022308, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000c3f55f42e5fa00511d1cd5a6ffd2ab02ba6b75f0b73e6d25f7b2d464897"); 

        pchMessageStart[0] = 0x83;
        pchMessageStart[1] = 0xc9;
        pchMessageStart[2] = 0xc2;
        pchMessageStart[3] = 0x67;
        vAlertPubKey = ParseHex("04cb93095af6ce8b5a2f631f694793999e2ba3ee268c0af8f15b60c38a9ac6fd322e3fb764a51f9cd2828a1d4949d664f776f55958e36f28def69ba1e20a5eedf2");
        nDefaultPort = 21336;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1565022313UL, 1255065UL, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c3f55f42e5fa00511d1cd5a6ffd2ab02ba6b75f0b73e6d25f7b2d464897"));
        assert(genesis.hashMerkleRoot == uint256S("0xb6a4cfad2b5005b482e15937e824f85c8ac7d3bf3e93c5a0d394611f50358b37"));
        ...
        // Testnet ColonyCash BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet ColonyCash BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet ColonyCash BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"DK898UpvuieS3KXUQR86GYGorMtKaHXGz7"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000c3f55f42e5fa00511d1cd5a6ffd2ab02ba6b75f0b73e6d25f7b2d464897"))
        };

        chainTxData = ChainTxData{
            1565022313, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1565022318, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1dc426cd6f91ccecf76be49e64b43fe85aa9957cefd62d7e65e5f6e3becea34d"));
        assert(genesis.hashMerkleRoot == uint256S("0xb6a4cfad2b5005b482e15937e824f85c8ac7d3bf3e93c5a0d394611f50358b37"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("colonycashevo.org",  "devnet-seed.colonycashevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x1dc426cd6f91ccecf76be49e64b43fe85aa9957cefd62d7e65e5f6e3becea34d"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6JnEjmGoMDrZ5LgTucdhTHyfGgpk1icNhuvA1GehH33XC1a2dv1
        vSporkAddresses = {"DSzEaX6M9PYt9osVV3SSeZKnNNj4afoF6Y"};
        nMinSporkKeys = 1;
        ...
        // Regtest ColonyCash addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        // Regtest ColonyCash script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Regtest ColonyCash BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest ColonyCash BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest ColonyCash BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
