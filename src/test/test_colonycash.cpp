...
#define BOOST_TEST_MODULE ColonyCash Test Suite

#include "test_colonycash.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_colonycash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
