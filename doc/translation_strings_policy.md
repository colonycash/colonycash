...
This document provides guidelines for internationalization of the ColonyCash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `colonycash_en.ts` remains unchanged.
